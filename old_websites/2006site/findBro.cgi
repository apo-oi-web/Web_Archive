...
print '<div class = "inhalt">
	...
	<H2> Find a Brother </H2>
	<p> Leave the % symbol if you are unsure of a fields value, or would like a list of the whole brotherhood</p>
	...
	<label for = \"fname\">Enter Brother's First Name (Required) </label> <br/>
	<input type = \"text\" name = \"fname\" id = \"fname\" value = \"%\" tabstop = \"9\"/> <br/>
	
	<label for = \"lname\"> Enter Brother's Last Name (optional)</label><br/>
	<input type = \"text\" name = \"lname\" id = \"lname\" value = \"%\" tabstop = \"10\" /><br/>
	
	<input type = \"submit\" value = \"Find Brother\" onclick=\"validate('./findBrother.cgi')\" tabstop = \"11\" />
	<input type = \"submit\" value = \"Return to Brother Page\" onclick=\"validate('./brotherLogin.cgi')\" tabstop = \"12\" />
	</form>
