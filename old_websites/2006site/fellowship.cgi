...
#!allows you to do CGI things, and have error msgs print to browser
use CGI;
...
print '<div class = "about" >
       ...
       <p class = "rp1"><div><Q>People rarely succeed unless they have fun in what they are doing.</Q>
	-Dale Carnegie</div><br/>
	<div><Q>In union there is strength.</Q></div>-Aesop
       </p>
	</div>';
...
print '<div class = "inhalt" style = "overflow: auto;">
       ...
       <h2><span class = "indexTitle">Upcoming Fellowship Events</span></h2>

       <div class = "fellowshipSchedule">
       <ul>';

       my $futureService = $dbh->prepare("SELECT * FROM EVENTS WHERE Start > NOW() AND Type = 'Fellowship' ORDER BY Start");
